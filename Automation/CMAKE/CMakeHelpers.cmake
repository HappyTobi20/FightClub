...
macro(setup_conan)
    ...
    # Явно указываем Conan'у, что для мультиконфигурационного генератора
    # нужно поставить обе конфигурации
    get_property(_is_multi_config GLOBAL PROPERTY GENERATOR_IS_MULTI_CONFIG)
    if(_is_multi_config)
        set(CONAN_INSTALL_BUILD_CONFIGURATIONS "Debug;Release" CACHE STRING "Conan build configurations")
    endif()
endmacro()